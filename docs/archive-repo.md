...
4. Select the `Archive A Repository` template.
![image](https://github.com/user-attachments/assets/5d2d2826-b7f1-4bdf-98ae-2d4628990704)
...
11. Regardless of the result, the `Archive A Repository` request is now complete.
